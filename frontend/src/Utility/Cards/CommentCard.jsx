          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              {image ? (
                ...
                <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 flex items-center justify-center border-2 border-white dark:border-gray-700 shadow-sm">
                  <User size={20} />
                </div>
              )}
