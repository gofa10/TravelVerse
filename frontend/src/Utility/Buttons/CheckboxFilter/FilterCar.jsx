...
// import image from '../../../Assets/images/car-lg-removebg-preview.png';
import { Col, Row } from 'react-bootstrap';
import AccessibilityIcon from '@mui/icons-material/Accessibility';
import LuggageIcon from '@mui/icons-material/Luggage';
import WorkIcon from '@mui/icons-material/Work';

const FilterCar = ({ label, passengers, luggage, work, price,image }) => {
  return (
    <StyledWrapper>
      <div className="checkbox-wrapper-16">
        <label className="checkbox-wrapper">
          ...
          <span className="checkbox-tile">
            ...
            <span className="checkbox-label">From {price} Total</span>
          </span>
        </label>
      </div>
    </StyledWrapper>
